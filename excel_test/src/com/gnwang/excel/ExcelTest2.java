...
public class ExcelTest2 {
	...
	public static void readExcel(String filePath) {
		...
		try {
			...
			/**
			 * 
			 * //获得第一行第一列单元的值 Cell c00 = st.getCell(0,0); //通用的获取cell值的方式,返回字符串 String
			 * strc00 = c00.getContents(); //获得cell具体类型值的方式 if(c00.getType() ==
			 * CellType.LABEL) { LabelCell labelc00 = (LabelCell)c00; strc00 =
			 * labelc00.getString(); } //输出 System.out.println(strc00);
			 */
	...
	public static void writeExcel(OutputStream os) {
		try {
			 ...
			 * protected类型：方法一：直接从目标文件中读取 WritableWorkbook wwb = Workbook.createWorkbook(new
	...
	public static void main(String args[]) {
		try {
			// 读EXCEL
			ExcelTest2.readExcel("F:/红楼人物.xls");
			// 输出EXCEL
			File filewrite = new File("F:/红楼人物2.xls");
			filewrite.createNewFile();
			OutputStream os = new FileOutputStream(filewrite);
			ExcelTest2.writeExcel(os);

			// 修改EXCEL
			ExcelTest2.modifyExcel(new File("F:/红楼人物.xls"), new File("F:/红楼人物3.xls"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
